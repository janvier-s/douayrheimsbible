...
<div class="space-y-md text-sm font-ui">
	...
	<div class="border-t border-border pt-md space-y-sm">
		<span class="block text-subtle text-xs uppercase tracking-[0.1em]">Verse display</span>
		<label class="flex items-center gap-sm cursor-pointer">
			<input
				type="checkbox"
		...
		<label class="flex items-center gap-sm cursor-pointer">
			<input
				...
				class="accent-accent"
			/>
			<span>Protestant Psalm numbering</span>
		</label>
		<label class="flex items-center gap-sm cursor-pointer">
			<input
				type="checkbox"
