...
- **Image placeholders:** preserve or enhance existing `<figure>` / `article-figure-placeholder` blocks ; add a new placeholder for any new substantive section that would naturally carry an image (use the same pattern: `<figure class="article-figure"><div class="article-figure-placeholder" data-label="...descriptive label..."></div><figcaption>...</figcaption></figure>`).
